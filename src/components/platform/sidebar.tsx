...
> = {
  super_admin: [
    ...
    { label: "Audit Log", href: "/super-admin", icon: FileText },
    { label: "Settings", href: "/super-admin", icon: Settings },
  ],
  principal: [
    { label: "Dashboard", href: "/dashboard", icon: LayoutDashboard },
    { label: "Students", href: "/principal", icon: GraduationCap },
    { label: "Staff", href: "/principal", icon: Users },
    { label: "Attendance", href: "/principal", icon: ClipboardCheck },
    { label: "Fees & Finance", href: "/principal", icon: DollarSign },
    { label: "Academics", href: "/principal", icon: BookOpen },
    { label: "Admissions", href: "/principal", icon: UserCheck },
